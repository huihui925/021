...
$config['db']['master']['username'] = 'ek021';
$config['db']['master']['password'] = 'ek021';
$config['db']['master']['port'] = '3306';
$config['db']['master']['database'] = 'ek021';
...
$config['setting']['authkey'] = '96e256ec';
...
$config['setting']['redis']['auth'] = 'wwsl2019';  //redis密码, 默认为空
$config['setting']['redis']['requirepass'] = 'wwsl2019';   //redis密码，默认为空

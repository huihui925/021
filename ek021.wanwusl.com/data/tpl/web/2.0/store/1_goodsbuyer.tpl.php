		...
		<a href="<?php  echo $this->createWebUrl('goodsbuyer', array('operate' => 'goods_info', 'direct' => 1, 'goods' => $goods['id']))?>" class="wish-goods-item">
			<div class="wish-goods-box">
				...
				<div class="info text-over">
					<div class="title text-over"><?php  echo $goods['title'];?><?php  echo $goods['num'];?></div>
					<div class="price">
		...
		<div class="wish-goods-item">
			<div class="wish-goods-box">
				...
				<div class="info text-over">
					...
					<div class="price">¥ <?php  echo $goods['price'];?>元/<?php  if($goods['type'] != STORE_TYPE_API) { ?><?php  if($goods['unit'] == 'month') { ?>月<?php  } else if($goods['unit'] == 'day') { ?>日<?php  } else if($goods['unit'] == 'year') { ?>年<?php  } ?><?php  } ?></div>
					<div class="support">
		...
		<div class="wish-goods-item">
			<div class="wish-goods-box">
				...
				<div class="info text-over">
					...
					<div class="price">¥ <?php  echo $goods['price'];?>元/<?php  if($goods['unit'] == 'month') { ?>月<?php  } else if($goods['unit'] == 'day') { ?>日<?php  } else if($goods['unit'] == 'year') { ?>年<?php  } ?></div>
					<div class="support">
						<!-- 适用 <i class="wi wi-wxapp"></i> -->
					</div>
				</div>
	...
	<div class="wish-goods-detail <?php  if($goods['type'] == STORE_TYPE_PACKAGE) { ?>jurisdiction-detail<?php  } else { ?>module-detail<?php  } ?>"">
		<div class="wish-goods-info">
			...
			<div class="price-box">
				...
				<?php  if($all_type_info[$goods['type']]['group'] == 'module' || in_array($goods['type'], array(STORE_TYPE_PACKAGE, STORE_TYPE_ACCOUNT_RENEW, STORE_TYPE_WXAPP_RENEW, STORE_TYPE_USER_PACKAGE, STORE_TYPE_ACCOUNT_PACKAGE))) { ?>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="" method="get" class="we7-form">
						<div class="form-group">
							<label class="control-label col-sm-2">应用单价</label>
							<div class="col-sm-8 form-control-static">￥<?php  echo $goods['price'];?><?php  if($goods['type'] != STORE_TYPE_API && $goods['type'] != STORE_TYPE_ACCOUNT && $goods['type'] != STORE_TYPE_WXAPP) { ?>/<?php  if($goods['unit'] == 'month') { ?>月<?php  } else if($goods['unit'] == 'day') { ?>日<?php  } else if($goods['unit'] == 'year') { ?>年<?php  } ?><?php  } ?></div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2">费用明细</label>
							<div class="col-sm-8 form-control-static">实付总计<span class="we7-margin-left">￥{{ price }}</span></div>

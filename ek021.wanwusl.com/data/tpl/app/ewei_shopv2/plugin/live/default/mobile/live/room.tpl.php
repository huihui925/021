...
<div class="fui-page">
    <div class="fui-content <?php  if($fullscreen) { ?>fullscreen<?php  } ?>">
        ...
        <div class="block-video" style="background-image: url('<?php  echo $poster;?>');">
            ...
            <video class="video vjs-fluid" id="player" src="<?php  echo $video;?>" webkit-playsinline="true" playsinline="true" x-webkit-airplay="true"  x5-video-player-type="h5" x5-video-player-fullscreen="true"></video>
        ...
        <!--商品弹层 -->
        <div class="layer-goods layer" style="z-index:99999">
            <div class="layer-close"></div>
            <div class="inner">
                <?php  if(is_array($room_goods)) { foreach($room_goods as $row) { ?>
...
<script type="text/javascript" charset="utf-8">
    ...
    $('#input').focus(function(){
        // var height = $('.fui-content').css('height');
        // alert(height);
    })
    $('#input').blur(function(){

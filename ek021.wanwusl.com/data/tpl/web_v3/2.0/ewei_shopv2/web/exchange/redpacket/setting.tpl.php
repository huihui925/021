...
<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="#home" data-toggle="tab"><?php  if($id>0) { ?>编辑红包兑换<?php  } else { ?>添加红包兑换<?php  } ?></a></li>
...
<div class="form-group">
    ...
    <div class="col-sm-9  col-xs-12">
        <div class="input-group">
            ...
            <input type="text" name="sendname" class="form-control" required placeholder="必填" value="<?php  echo $setting['sendname'];?>">
        </div>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-9  col-xs-12">
        <div class="input-group">
            ...
            <input type="text" name="actname" class="form-control" required placeholder="必填" value="<?php  echo $setting['actname'];?>">
        </div>
    </div>
</div>
<div class="form-group">

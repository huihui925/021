...
<div class="form-group">
    <label class="col-lg control-label must">商户临时无权限账号</label>
    <div class="col-sm-8">

        <input type="text" class="form-control" name="data[temporaryusername]" value="<?php  echo $data['temporaryusername'];?>" data-rule-required="true"/>

    </div>
</div>
<div class="form-group">
    <label class="col-lg control-label must">商户临时无权限密码</label>
    <div class="col-sm-8">

        <input type="text" class="form-control" name="data[temporarypassword]" value="<?php  echo $data['temporarypassword'];?>" data-rule-required="true"/>

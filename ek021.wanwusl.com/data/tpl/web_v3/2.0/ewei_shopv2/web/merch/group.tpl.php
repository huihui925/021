    ...
    <table class="table table-responsive table-hover" >
        ...
        <tr>
            ...
            <td style="text-align:left;">
                ...
                <?php if(cv('merch.group.delete')) { ?>
                <a data-toggle='ajaxRemove' href="<?php  echo webUrl('merch/group/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm  btn-operation btn-op" data-confirm='确认要删除此分组吗?'>

...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <?php if( ce('merch.user' ,$item) ) { ?>
        <?php echo tpl_selector('payopenid',array('value'=>!empty($user['nickname'])?$user['nickname']:"",'required'=>false,'preview'=>false,'key'=>'openid','text'=>'nickname','type'=>'text','placeholder'=>'昵称/姓名/手机号','buttontext'=>'选择收款人 ', 'items'=>$user,'url'=>webUrl('member/query') ))?>
        <?php  } else { ?>

    ...
    <form method="post" class="form-horizontal form-validate">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <span class="help-block">开启七牛存储，关闭则本地存储，如果用户可自己单独设七牛存储 ，不设置则用系统的设置 <a class="text-primary" href="http://www.qiniu.com/" target="_blank">七牛存储</a></span>
                <?php  } else { ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php if(cv('sysset.qiniu.edit')) { ?>
                <input type="text" name="data[secret_key]" class="form-control" value="<?php  echo $data['secret_key'];?>"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php if(cv('sysset.qiniu.edit')) { ?>
                <input type="text" name="data[bucket]" class="form-control" value="<?php  echo $data['bucket'];?>"
                       data-rule-required='true'/>
                <?php  } else { ?>

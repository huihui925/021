...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('lottery.edit')) { ?>
        <?php  echo tpl_form_field_eweishop_daterange('award_time', array('starttime'=>date('Y-m-d H:i', $award_starttime),'endtime'=>date('Y-m-d H:i', $award_endtime)),true);?>
            ...
            <div class="col-sm-4 col-xs-4 ">
                <div class="input-group">
                    <label class="checkbox-inline">
                        <input type="checkbox" name="pay_type[]" <?php  if($item['task_data']['pay_type'] != "2") { ?>checked<?php  } ?> value="1"> 付款后
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="pay_type[]" <?php  if($item['task_data']['pay_type'] != "1") { ?>checked<?php  } ?> value="2"> 订单完成
                    </label>
                </div>
            </div>
        </div>
    ...
    function task_change(obj) {
        ...
        if(task_type==1){
            task_div = '<div class="row"><div class="col-sm-4 col-xs-4 "><div class="input-group"><span class="input-group-addon">满</span><input type="number" class="form-control" name="pay_money" placeholder="0"> <span class="input-group-addon">元</span></div>'
                    ...
                    +'<div class="col-sm-4 col-xs-4 "><div class="input-group"><label class="checkbox-inline"><input type="checkbox" name="pay_type[]" value="1"> 付款后</label><label class="checkbox-inline"><input type="checkbox" name="pay_type[]" value="2"> 订单完成</label></div></div></div>';
        }
        if(task_type==2){

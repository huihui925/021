...
<div class="alert alert-warning">抽奖所有等级不能低于5个，概率之和可不等于100%，概率可设置最大最小值为小数点前三位，小数点后三位</div>
...
//          $('#rec-rank .panel')
          ...
          if(!ret.test(probability)){
              tip.msgbox.err('小数点后仅限输入三位');
              return;
          }
          if(probability==''){
...
//                  }
          ...
          if(datatype==3){
              ...
              recbribery = parseFloat(recbribery);

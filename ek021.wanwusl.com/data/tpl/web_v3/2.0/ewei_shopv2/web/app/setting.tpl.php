...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="radio-inline">
            <input class="subscribe-pay" type="radio" value="1" name="set[subscribepay]" <?php  if(!empty($sets['app']['subscribepay'])) { ?>checked<?php  } ?>> 启用</label>
        <label class="radio-inline">
            <input class="subscribe-pay" type="radio" value="0" name="set[subscribepay]" <?php  if(empty($sets['app']['subscribepay'])) { ?>checked<?php  } ?>> 不启用</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="radio-inline">
            <input class="subscribe-send" type="radio" value="1" name="set[subscribesend]" <?php  if(!empty($sets['app']['subscribesend'])) { ?>checked<?php  } ?>> 启用</label>
        <label class="radio-inline">
            <input class="subscribe-send" type="radio" value="0" name="set[subscribesend]" <?php  if(empty($sets['app']['subscribesend'])) { ?>checked<?php  } ?>> 不启用</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="radio-inline">
            <input class="subscribe-autosend"  type="radio" value="1" name="set[subscribeautosend]" <?php  if(!empty($sets['app']['subscribeautosend'])) { ?>checked<?php  } ?>> 启用</label>
        <label class="radio-inline">
            <input class="subscribe-autosend" type="radio" value="0" name="set[subscribeautosend]" <?php  if(empty($sets['app']['subscribeautosend'])) { ?>checked<?php  } ?>> 不启用</label>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <label class="radio-inline">
            <input class="subscribe-receive" type="radio" value="1" name="set[subscribereceive]" <?php  if(!empty($sets['app']['subscribereceive'])) { ?>checked<?php  } ?>> 启用</label>
        <label class="radio-inline">
            <input class="subscribe-receive" type="radio" value="0" name="set[subscribereceive]" <?php  if(empty($sets['app']['subscribereceive'])) { ?>checked<?php  } ?>> 不启用</label>
    </div>
</div>
...
//        });
    ...
    // 买家支付通知 TODO 加加载中
    var paystatus = '<?php  echo $subscribe_list["pay"];?>';
    if (paystatus == '') {
        $('.subscribe-pay').click(function () {

            var check = $('input:radio[name="set[subscribepay]"]:checked').val();
            if (check == 1) {
                setTemplate('pay');
            }
        });
    ...
    // 卖家发货通知
    var sendstatus = '<?php  echo $subscribe_list["send"];?>';
    if (sendstatus == '') {
        $('.subscribe-send').click(function () {
            var check = $('input:radio[name="set[subscribesend]"]:checked').val();
            if (check == 1) {
                setTemplate('send');
            }
        });
    ...
    // 自动发货通知
    var autosendstatus = '<?php  echo $subscribe_list["autosend"];?>';
    if (autosendstatus == '') {
        $('.subscribe-autosend').click(function () {
            var check = $('input:radio[name="set[subscribeautosend]"]:checked').val();
            if (check == 1) {
                setTemplate('autosend');
            }
        });
    }

    // 买家收货通知
    var receivestatus = '<?php  echo $subscribe_list["receive"];?>';
    if (receivestatus == '') {
        $('.subscribe-receive').click(function () {
            var check = $('input:radio[name="set[subscribereceive]"]:checked').val();
            if (check == 1) {
                setTemplate('receive');
            }
        });
